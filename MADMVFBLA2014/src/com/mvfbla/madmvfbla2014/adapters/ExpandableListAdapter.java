...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	private Context context;// Interface to global information about an
							// application environment
	private ArrayList<Submission> questions;// list of the questions

	public ExpandableListAdapter(Context context,
			ArrayList<Submission> questions) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		TextView likes = (TextView) convertView
				.findViewById(R.id.numLikeComment);
		likes.setText(comment.getNumLikes() + "");
		ImageView iv = (ImageView) convertView
				.findViewById(R.id.addLikeComment);
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (isExpanded) {
			convertView.setBackgroundColor(Color.rgb(255, 128, 0));// react to
																	// press
