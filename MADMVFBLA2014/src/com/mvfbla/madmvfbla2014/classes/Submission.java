...
public class Submission {
	...
	protected int numLikes;// number of likes
	protected Date timePosted, timeReplied;// records when the submission was
											// posted
	protected ArrayList<Submission> replies;// an ArrayList of all replies to
											// this submission
	...
	public Submission() {// initialize class variables
		replies = new ArrayList<Submission>(0);// size of zero
		numLikes = 0;
		timePosted = new Date();
	...
	// when user likes a post. icon is toggled and points added is sent to
	// server
	public void like(final Activity act,
			final ExpandableListAdapter expAdapter, final View view) {
